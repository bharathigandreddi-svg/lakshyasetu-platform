...
window.addEventListener('load',function(){
  ...
  const s=document.createElement('script');s.src='payments-v2.js?v=20260824-1525';s.defer=true;s.setAttribute('data-lakshyasetu-payment-v2','true');document.head.appendChild(s);
});
