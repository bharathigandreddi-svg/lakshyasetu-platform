...
window.addEventListener('load',function(){window.__LS_PAYMENT_MODULE_LOADED=false;const s=document.createElement('script');s.src='payments-v2.js?v=20260824-1338';s.defer=true;document.head.appendChild(s);});
