(function(){'use strict';
  ...
  async function run(){
    ...
    try{
      ...
      render(fallbackSeries,[{id:1,title:'UPSC Civil Services',exam_code:'UPSC'},{id:2,title:'APPSC Group 1',exam_code:'APPSC_GROUP_1'},{id:3,title:'APPSC Group 2',exam_code:'APPSC_GROUP_2'}],[],{1:2,2:2,3:2,4:0});
