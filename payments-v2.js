/* LakshyaSetu Razorpay payment client v4 */
(function(){
  if(window.__LS_PAYMENT_V4_ACTIVE)return;
  window.__LS_PAYMENT_V4_ACTIVE=true; window.__LS_PAYMENT_MODULE_LOADED=true;
  ...
  async function invoke(name,body){
    ...
    const text=await r.text();let data=null;try{data=text?JSON.parse(text):null;}catch(_e){}
